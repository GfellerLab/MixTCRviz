...
#'   
#' @param baseline (default=NULL) R object (list) or .rds/.rda/.rdata file containing all data about the
...
MixTCRviz <- function(input1, output.path,
  ...
  input1 <- check_input(input1, chain.list.output, "input1", species.default, model.default, input.list=input1.list)
  if(!input1.list){
  ...
  if(comp.baseline==0){
    ...
    input2 <- check_input(input2, chain.list.output, "input2", species.default, model.default, input.list=input2.list)
    if(!input2.list){
