...
#'   In this case, the comparison of CDR3 lengths and CDR3 motifs is done without accounting for P(V,J) in input1 (i.e., renormVJ=FALSE), unless renormVJ is set manually to TRUE.
