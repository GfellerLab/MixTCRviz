...
## Optional parameters:
 ...
 - return.plot (default=FALSE): It TRUE, return the list of plots.
      For optimal layout in Rstudio, you can use a command like `dev.new(width = 15, height = 8, reset = FALSE)`
